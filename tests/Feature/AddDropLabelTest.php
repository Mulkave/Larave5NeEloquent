...
class AddDropLabelsTest extends TestCase
{
    public function setUp()
    {
        ...
        $resolver->shouldReceive('connection')->andReturn($this->getConnectionWithConfig('neo4j'));
        \Vinelab\NeoEloquent\Tests\Functional\AddDropLabels\Labelwiz::setConnectionResolver($resolver);
    }
    ...
    public function testAddDropLabelsOnRelated()
    {
        ...
        $foo = \Vinelab\NeoEloquent\Tests\Functional\AddDropLabels\Foo::createWith(['prop' => 'I am Foo'], ['bar' => ['prop' => 'I am Bar']]);
